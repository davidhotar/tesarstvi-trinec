...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_archive_relation_to" AS ENUM('portfolio');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_archive_relation_to" AS ENUM('portfolio');
  ...
  CREATE TABLE "pages_blocks_archive" (
  	...
  	"relation_to" "enum_pages_blocks_archive_relation_to" DEFAULT 'portfolio',
  ...
  CREATE TABLE "_pages_v_blocks_archive" (
  	...
  	"relation_to" "enum__pages_v_blocks_archive_relation_to" DEFAULT 'portfolio',
  	"limit" numeric DEFAULT 10,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "portfolio_populated_authors" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar
  ...
  CREATE TABLE "_portfolio_v_version_populated_authors" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_uuid" varchar,
  ...
  CREATE TABLE "payload_mcp_api_keys" (
  	...
  	"label" varchar,
  	"description" varchar,
  	"portfolio_find" boolean DEFAULT false,
  	"portfolio_create" boolean DEFAULT false,
  	"portfolio_update" boolean DEFAULT false,
  	"portfolio_delete" boolean DEFAULT false,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  ALTER TABLE "portfolio_populated_authors" ADD CONSTRAINT "portfolio_populated_authors_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."portfolio"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "portfolio_rels" ADD CONSTRAINT "portfolio_rels_users_fk" FOREIGN KEY ("users_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_portfolio_v_version_populated_authors" ADD CONSTRAINT "_portfolio_v_version_populated_authors_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_portfolio_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_portfolio_v_rels" ADD CONSTRAINT "_portfolio_v_rels_categories_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_portfolio_v_rels" ADD CONSTRAINT "_portfolio_v_rels_users_fk" FOREIGN KEY ("users_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "redirects_rels" ADD CONSTRAINT "redirects_rels_portfolio_fk" FOREIGN KEY ("portfolio_id") REFERENCES "public"."portfolio"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "search_rels" ADD CONSTRAINT "search_rels_portfolio_fk" FOREIGN KEY ("portfolio_id") REFERENCES "public"."portfolio"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "portfolio_populated_authors_order_idx" ON "portfolio_populated_authors" USING btree ("_order");
  CREATE INDEX "portfolio_populated_authors_parent_id_idx" ON "portfolio_populated_authors" USING btree ("_parent_id");
  CREATE INDEX "portfolio_hero_image_idx" ON "portfolio" USING btree ("hero_image_id");
  ...
  CREATE INDEX "portfolio_rels_users_id_idx" ON "portfolio_rels" USING btree ("users_id");
  CREATE INDEX "_portfolio_v_version_populated_authors_order_idx" ON "_portfolio_v_version_populated_authors" USING btree ("_order");
  CREATE INDEX "_portfolio_v_version_populated_authors_parent_id_idx" ON "_portfolio_v_version_populated_authors" USING btree ("_parent_id");
  CREATE INDEX "_portfolio_v_parent_idx" ON "_portfolio_v" USING btree ("parent_id");
  CREATE INDEX "_portfolio_v_version_version_hero_image_idx" ON "_portfolio_v" USING btree ("version_hero_image_id");
  ...
  CREATE INDEX "_portfolio_v_rels_categories_id_idx" ON "_portfolio_v_rels" USING btree ("categories_id");
  CREATE INDEX "_portfolio_v_rels_users_id_idx" ON "_portfolio_v_rels" USING btree ("users_id");
  ...
  CREATE INDEX "redirects_rels_portfolio_id_idx" ON "redirects_rels" USING btree ("portfolio_id");
  ...
  CREATE INDEX "search_rels_portfolio_id_idx" ON "search_rels" USING btree ("portfolio_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "portfolio_populated_authors" CASCADE;
  DROP TABLE "portfolio" CASCADE;
  DROP TABLE "portfolio_rels" CASCADE;
  DROP TABLE "_portfolio_v_version_populated_authors" CASCADE;

...
import type { TimelineSectionBlock as TimelineSectionBlockProps } from '@/payload-types'

export const TimelineSectionBlock: React.FC<TimelineSectionBlockProps> = ({
  title,
  milestones,
}) => {
  return (
              ...
              milestones.map((m, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div className="inline-block rounded-xl border bg-card p-5 text-left shadow-sm">
